...
import { Package, ShareNetwork, UserPlus, SignOut, House, Users, Lock, ChartLine, ChatCircleDots, Briefcase, Article, Question, EnvelopeSimple } from "@phosphor-icons/react";
...
const navItems: NavItem[] = [
  ...
  { key: "blog", label: "Blog Posts", icon: Article },
  { key: "faq", label: "FAQ", icon: Question },
  { key: "messages", label: "Messages", icon: EnvelopeSimple },
