...
import logisticsImg from "@/assets/pages/hero-logistics.jpg";
...
const SourcingGuidePage = () => {
  ...
  return (
    <>
      <Navbar />
      <CinematicHero
        tag={t("sourcingGuidePage.tag")}
        title={t("sourcingGuidePage.title")}
        subtitle={t("sourcingGuidePage.subtitle")}
        image={heroImg}
      />
