...
const QualityInspectionPage = () => {
  ...
  return (
    <>
      ...
      <SplitSection
        tag={t("qualityInspectionPage.splitTag")}
        title={t("qualityInspectionPage.splitTitle")}
        text={t("qualityInspectionPage.intro")}
        image={servicesImg}
      />

      <ProcessTimeline
        tag={t("qualityInspectionPage.processTag")}
        title={t("qualityInspectionPage.processTitle")}
        subtitle={t("qualityInspectionPage.processSubtitle")}
      ...
      <section className="section-padding gradient-dark">
        <div className="container-narrow">
          <ScrollReveal animation="card" stagger={0.1} className="grid gap-6 sm:grid-cols-3">
            {[
              { val: "100%", label: t("qualityInspectionPage.statsCheck") },
              { val: "AQL", label: t("qualityInspectionPage.statsSampling") },
              { val: "24h", label: t("qualityInspectionPage.statsReport") },
            ].map((s, i) => (
      ...
      <FullWidthCTA title={t("qualityInspectionPage.ctaTitle")} buttonLabel={t("hero.cta1")} href="/contact" />
      <Footer />
      <WhatsAppButton />
    </>
  );
